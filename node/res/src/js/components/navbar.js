...
class NavBar extends HTMLElement {
	constructor() {
		...
		if (this.hasAttribute('data-authorized')) {
			...
			<li><a href="/waitroom" class="nav-link" data-link id="remote">Play Rem</a></li>
			<li><a href="/tournament" class="nav-link" data-link id="tournamet">Tournament</a></li>
			...
			<li><a class="dropdown-item" href="/profile" data-link id="inProfile">Profile</a></li>
			<li><a id="logout-btn" class="dropdown-item" href="" data-link>Log out</a></li>
			</ul>
			</li>
			`;
		}
		...
		<header class="topnav wraper d-flex justify-content-between">
			<h1 class="navbar-brand"><a href="/" data-link>Transcendence</a></h1>
			<nav>
				<div class="div topnav__menu">
					...
					<div class="topnav__list topnav__menu__hidden">
						<ul class="topnav__links d-flex gap-4">
						<li class="nav-item dropdown">
							${optionalElements}
							<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="language">
							Language
							</a>
							<ul class="dropdown-menu dropdown-menu-end">
	...
	connectedCallback() {
		...
		*/
		...
		function	updateLightMode() {
			lightModeSwitch.forEach( elementSwitch => {
				elementSwitch.classList.toggle('visible_cs');
				elementSwitch.classList.toggle('invisible_cs');
				elementSwitch.animate(spin, time);
			});
