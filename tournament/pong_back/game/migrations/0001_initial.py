    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winner', models.ForeignKey(blank=True, db_column='winnerid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'tournament',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament', models.ForeignKey(db_column='tournamentid', on_delete=django.db.models.deletion.CASCADE, to='game.tournament')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_match', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='game.match')),
                ...
                ('tournament', models.ForeignKey(blank=True, db_column='tournamentid', null=True, on_delete=django.db.models.deletion.CASCADE, to='game.tournament')),
            ],
            options={
                'ordering': ['game_date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genId', models.CharField(editable=False, max_length=16, unique=True)),
                ('expire_at', models.DateTimeField(default=game.models.default_expire_at)),
                ('attendee', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attending_room', to=settings.AUTH_USER_MODEL)),
                ('owner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owner_room', to=settings.AUTH_USER_MODEL)),
            ],
            options={
